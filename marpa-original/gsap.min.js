...
!((t, e) => {
	...
	var B,
		...
		J = Math.cos,
		H = Math.sin,
		Z = ("function" == typeof ArrayBuffer && ArrayBuffer.isView) || (() => {}),
		$ = Array.isArray,
		tt = /(?:-?\.?\d|\.)+/gi,
		et = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,
		rt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g,
			...
			ot.SteppedEase =
				{
					config: function config(t, e) {
						...
						var r = 1 / t,
							i = t + (e ? 0 : 1),
							n = e ? 1 : 0;
						return (t) => (((i * kt(0, 0.99999999, t)) | 0) + n) * r;
					},
				}),
		(V.ease = Bt["quad.out"]),
		ha(
			...
			if (
				...
				if (
					...
					var C,
						...
						E,
						D = 0;
					if ($(x)) x.forEach((t) => s.to(A, t, ">")), s.duration();
					else {
						for (l in ((u = {}), x))
							"ease" === l || "easeEach" === l || gc(l, x[l], u, x.easeEach);
						for (l in u)
							for (
								C = u[l].sort((t, e) => t.t - e.t), o = D = 0;
								o < C.length;
								o++
							)
								((E = {
	...
	var me,
		...
		Pe =
			(((me = Context.prototype).add = function add(t, i, n) {
				...
				s(t) && ((n = i), (i = t), (t = s));
				return (this.last = Ew), t === s ? Ew(this) : t ? (this[t] = Ew) : Ew;
			}),
				...
				if (e) {
					...
					this.data.forEach((t) => {
						"isFlip" === t.data &&
							...
							t
								.getChildren(!0, !0, !1)
								.forEach((t) => i.splice(i.indexOf(t), 1)));
					}),
						i
							.map((t) => ({ g: t.globalTime(0), t: t }))
							.sort((t, e) => e.g - t.g || -1 / 0)
							.forEach((t) => t.t.revert(e)),
						this.data.forEach(
							(t) => !(t instanceof Zt) && t.revert && t.revert(e),
						),
						this._r.forEach((t) => t(e, this)),
						(this.isReverted = !0);
	...
	var Se = {
		...
		quickSetter: function quickSetter(r, e, i) {
			if (1 < (r = Ot(r)).length) {
				var n = r.map((t) => Ee.quickSetter(t, e, i)),
					a = n.length;
				return (t) => {
					for (var e = a; e--; ) n[e](t);
				};
	...
	ha("to,from,fromTo,delayedCall,set,killTweensOf", (t) => (Se[t] = Zt[t])),
	...
	function Jd(t, e) {
		...
		if (t in ar && n) {
			if (((this.tfm = this.tfm || {}), "transform" === t))
				return cr.transform.split(",").forEach((t) => Jd.call(this, t, e));
			if (
				(~(t = cr[t] || t).indexOf(",")
