...
!((t, e) => {
	...
	function _(t, e, i) {
		...
		const s = e[t],
			n = i[t];
		o(s) && o(n) ? b(s, n) : Object.hasOwn(e, t) || (e[t] = g(n));
	}
	...
	function Bi(t, e) {
		if (!e) return !1;
		const i = [],
			s = (t, e) => (Zt(e) ? (i.includes(e) || i.push(e), i.indexOf(e)) : e);
	...
	class _n {
		constructor(t) {
			(this._config = ((t) => (((t = t || {}).data = gn(t.data)), fn(t), t))(
				t,
			)),
	...
	function Ko(t) {
		...
		return (i, s) => {
			...
			n instanceof $n
				? (e = ((t, e) => ((t.backgroundColor = t.data.map(() => Xo(e++))), e))(
						i,
						e,
					))
				: n instanceof Yn
