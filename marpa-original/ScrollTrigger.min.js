...
!((e, t) => {
	...
	var E =
		((Observer.prototype.init = function init(e) {
			...
			(te = se._dc =
				...
				(se.disable = () => {
					se.isEnabled &&
						(Fe.filter((e) => e !== se && A(e.target)).length ||
							C(he ? ve : i, "scroll", F),
						se.isPressed &&
	...
	(E.version = "3.12.2"),
		...
		(E.register = P),
		(E.getAll = () => Fe.slice()),
		(E.getById = (t) => Fe.filter((e) => e.vars.id === t)[0]),
	...
	function La(e) {
		return (
			...
			(Ja(e)
				? () => ((Ot.width = Ne.innerWidth), (Ot.height = S), Ot)
				: () => _t(e))
		);
	}
	function Oa(e, t) {
	...
	function Rb(e, t) {
		ze.cache++,
			(!t && rt) || ze.forEach((e) => Ra(e) && e.cacheID++ && (e.rec = 0)),
	...
	function oc(c, e) {
		...
		return (
			((c[f] = u).wheelHandler = () =>
				uk.tween && uk.tween.kill() && (uk.tween = 0)),
		...
		Pt = function _refreshAll(e, t) {
			if (!st || e) {
				Wb(),
					...
					ze.forEach((e) => Ra(e) && ++e.cacheID && (e.rec = e()));
				var r = V("refreshInit");
				Ze && re.sort(),
					t || Qb(),
					ze.forEach((e) => {
					...
					Ct++,
					Q((rt = 2)),
					kt.forEach((e) => Ra(e.vars.onRefresh) && e.vars.onRefresh(e)),
			...
			((ScrollTrigger.prototype.init = function init(E, O) {
				if (
					...
					var A,
						...
						ke = this,
						Te = E.onRefreshInit && (() => E.onRefreshInit(ke)),
							...
							(p = Ra(ue.snapTo)
								...
								: "labels" === ue.snapTo
									? (function _getClosestLabel(t) {
											return (e) => Le.utils.snap(pb(t), e);
										})(O)
									: "labelsDirectional" === ue.snapTo
										? (function _getLabelAtDirection(r) {
												return (e, t) => rb(pb(r))(e, t.direction);
											})(O)
										: !1 !== ue.directional
											? (e, t) =>
													rb(ue.snapTo)(e, at() - Ee < 500 ? 0 : t.direction)
											: Le.utils.snap(ue.snapTo)),
							(g = ue.duration || { min: 0.1, max: 2 }),
							(g = Ta(g) ? Ve(g.min, g.max) : Ve(g, g)),
							(te = Le.delayedCall(ue.delay || o / 2 || 0.1, () => {
								var e = Ae(),
									t = at() - Ee < 500,
									r = A.tween;
								if (
					...
					if (
						...
						(ke.getVelocity = () => ((Ae() - B) / (at() - Ue)) * 1e3 || 0),
						(ke.endAnimation = () => {
						...
						(ke.labelToScroll = (e) =>
							(O &&
								O.labels &&
								(D || ke.refresh() || D) + (O.labels[e] / O.duration()) * N) ||
							0),
						(ke.getTrailing = (t) => {
							var e = kt.indexOf(ke),
								r =
							...
							).filter((e) => (0 < ke.direction ? e.end <= D : e.start >= F));
						}),
						(ke.update = (e, t, r) => {
							if (!de || r || e) {
								var n,
					...
					ae &&
						(function _queueRefreshAll() {
							if (nt !== Ct) {
								var e = (nt = Ct);
								requestAnimationFrame(() => e === Ct && Pt(!0));
							}
						})();
					...
					(lt = 1),
						...
						Le.matchMedia
							? ((ScrollTrigger.matchMedia = (e) => {
								...
								Le.addEventListener("matchMediaInit", () => Qb()),
								Le.addEventListener("matchMediaRevert", () => Pb()),
								Le.addEventListener("matchMedia", () => {
									Pt(0, 1), V("matchMedia");
								}),
								Le.matchMedia("(orientation: portrait)", () => (Ib(), Ib)))
	...
	(re.version = "3.12.2"),
		(re.saveStyles = (e) =>
			e
				...
				: U),
		(re.revert = (e, t) => Qb(!e, t)),
		(re.create = (e, t) => new re(e, t)),
		(re.refresh = (e) => (e ? Jb() : (s || re.register()) && Pt(!0))),
		(re.update = (e) => ++ze.cache && Q(!0 === e ? 2 : 0)),
		(re.clearScrollMemory = Rb),
		(re.maxScroll = (e, t) => Oa(e, t ? qe : He)),
		(re.getScrollFunc = (e, t) => K(J(e), t ? qe : He)),
		(re.getById = (e) => Tt[e]),
		(re.getAll = () => kt.filter((e) => "ScrollSmoother" !== e.vars.id)),
		(re.isScrolling = () => !!st),
		(re.snapDirectional = rb),
		(re.addEventListener = (e, t) => {
			var r = X[e] || (X[e] = []);
			~r.indexOf(t) || r.push(t);
		}),
		(re.removeEventListener = (e, t) => {
			var r = X[e],
				n = r && r.indexOf(t);
			0 <= n && r.splice(n, 1);
		}),
			...
			for (r in t)
				o[r] =
					"on" === r.substr(0, 2) && Ra(t[r]) && "onRefreshInit" !== r
						...
						: t[r];
			return (
				Ra(a) && ((a = a()), ub(re, "refresh", () => (a = t.batchMax()))),
				Ge(e).forEach((e) => {
					var t = {};
					for (r in o) t[r] = o[r];
	...
	function yc(e) {
		...
		return (
			...
			(a = Le.to(n, {
				...
				scrollX: f ? "+=0.1" : "+=0",
				scrollY: "+=0.1",
				modifiers: { scrollY: mc(b, b(), () => a.pause()) },
				onUpdate: Q,
	...
	(re.sort = (e) =>
		...
		(re.observe = (e) => new E(e)),
		(re.normalizeScroll = (e) => {
